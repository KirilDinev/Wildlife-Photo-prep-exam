...
const postSchema = new Schema({
    ...
    location: { type: String, maxlength: [15, 'Location must be most 15 characters long'] },
    date: {
        type: String,
    ...
    description: { type: String, minlength: [8, 'Description be at least 8 characters long'] },
